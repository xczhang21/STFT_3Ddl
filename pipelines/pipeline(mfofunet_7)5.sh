...
# 配置参数列表
configs=(
    "mfofunet_ss256_train pi concat"
    "mfofunet_ss256_train pi add"
    "mfofunet_ss256_train pi se"
    "mfofunet_ss256_train pi cross_attention"
    "mfofunet_ss256_train pi bilinear"
    "mfofunet_ss256_train pi transformer"
    "mfofunet_ss256_train pi dynamic_weight"
)
