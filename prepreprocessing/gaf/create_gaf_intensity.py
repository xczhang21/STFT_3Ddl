...
list_path = Path("/home/zhang03/zxc/STFT_3DDL/STFT_3Ddl/stft_3ddl/lists/DAS1K/phase_intensity/")
...
for data in tqdm(datas, desc="数据处理进度"):
    save_path = Path(f'/home/zhang03/zxc/STFT_3DDL/DATASETS/preprocessed_data/DAS1K_GAF/intensity/')
