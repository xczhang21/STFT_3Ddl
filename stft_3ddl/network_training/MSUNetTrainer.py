...
def MSUNet_trainer_msdas1k(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        save_grad_cam_multi(epoch_num, all_val_spectrums, model, [model.encoder1_1, model.encoder2_1, model.encoder3_1, model.decoder1], writer, save_CAM_interval, save_CAM_num, single_image=True)
...
if __name__ == '__main__':
    ...
    config.dataset.spectrum_size = 'ms'
