...
# 配置参数列表
configs=(
    "mfofunet_weightadd_ss256_train pi weight_add0.0"
    "mfofunet_weightadd_ss256_train pi weight_add0.1"
    "mfofunet_weightadd_ss256_train pi weight_add0.2"
    "mfofunet_weightadd_ss256_train pi weight_add0.3"
    "mfofunet_weightadd_ss256_train pi weight_add0.4"
    "mfofunet_weightadd_ss256_train pi weight_add0.5"
    "mfofunet_weightadd_ss256_train pi weight_add0.6"
    "mfofunet_weightadd_ss256_train pi weight_add0.7"
    "mfofunet_weightadd_ss256_train pi weight_add0.8"
    "mfofunet_weightadd_ss256_train pi weight_add0.9"
    "mfofunet_weightadd_ss256_train pi weight_add1.0"
)
