...
# 配置参数列表
configs=(
    "mfofunet_learnablespatialwiseadd_ss256_train pi learnable_spatial_wise_add_res"
    "mfofunet_learnablespatialwiseadd_ss256_train pi learnable_spatial_wise_add_nores"
    "mfofunet_learnablechannelwiseadd_ss256_train pi learnable_channel_wise_add_res"
    "mfofunet_learnablechannelwiseadd_ss256_train pi learnable_channel_wise_add_nores"
    "mfofunet_learnableadd_ss256_train pi learnable_add_res"
    "mfofunet_learnableadd_ss256_train pi learnable_add_nores"
)
