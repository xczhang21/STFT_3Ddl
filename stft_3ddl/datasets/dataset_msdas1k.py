...
if __name__ == '__main__':
    ...
    train_datasets = msds1k_dataset(base_dir=base_dir, list_dir=list_dir, split='train')
    test_datasets = msds1k_dataset(base_dir=base_dir, list_dir=list_dir, split='test')