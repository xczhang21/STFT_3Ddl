"""
该文件用来生成两个特征(phase和intensity)的数据集
"""
import os
import random
import numpy as np
...
def dataset_reader(data_dir, spectrum_size, sample_list, max_num_samples, split):
    datas = []
    features = ["phase", "intensity"]
    if split == "train":
        ...
        for sample in sample_list:
            ...
            data_paths = [os.path.join(data_dir, feature, f"matrixs/scale_{spectrum_size}", sample_id, f"{sample_id}.npz") for feature in features]
